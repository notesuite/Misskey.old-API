...
function default_1(db) {
    const schema = new mongoose_1.Schema({
        avatar: { type: mongoose_1.Schema.Types.ObjectId, required: false, default: null, ref: 'AlbumFile' },
        avatarPath: { type: String, required: false, default: null },
        banner: { type: mongoose_1.Schema.Types.ObjectId, required: false, default: null, ref: 'AlbumFile' },
        ...
        latestPost: { type: mongoose_1.Schema.Types.ObjectId, required: false, default: null },
        likedCount: { type: Number, required: false, default: 0 },
        likesCount: { type: Number, required: false, default: 0 },
        location: { type: String, required: false, default: null },
        name: { type: String, required: true },
        pinnedPost: { type: mongoose_1.Schema.Types.ObjectId, required: false, default: null, ref: 'Post' },
        ...
        wallpaper: { type: mongoose_1.Schema.Types.ObjectId, required: false, default: null, ref: 'AlbumFile' },
    ...
    schema.options.toObject.transform = (doc, ret) => {
        ...
        ret.avatarUrl = doc.avatar !== null
            ? `${config_1.default.fileServer.url}/${encodePath(doc.avatarPath)}`
            : `${config_1.default.fileServer.url}/defaults/avatar.jpg`;
        ret.avatarThumbnailUrl = `${ret.avatarUrl}?thumbnail`;
        delete ret.banner;
        delete ret.bannerPath;
        ret.bannerUrl = doc.banner !== null
            ? `${config_1.default.fileServer.url}/${encodePath(doc.bannerPath)}`
            : `${config_1.default.fileServer.url}/defaults/banner.jpg`;
        ...
        ret.wallpaperUrl = doc.wallpaper !== null
            ? `${config_1.default.fileServer.url}/${encodePath(doc.wallpaperPath)}`
            : `${config_1.default.fileServer.url}/defaults/wallpaper.jpg`;

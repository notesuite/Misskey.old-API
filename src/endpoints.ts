...
export default [
	...
	{ name: 'users/follow', login: true, limitDuration: hour, limitMax: 100, minInterval: second },
	{ name: 'users/unfollow', login: true, limitDuration: hour, limitMax: 100, minInterval: second },
	...
	{ name: 'posts/repost', login: true, limitDuration: hour, limitMax: 120, minInterval: 1 * second, limitKey: 'post' },

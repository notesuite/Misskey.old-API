...
export default [
	...
	{ endpoint: 'account/tags/update', login: true, limitDuration: day, limitMax: 100 },
	...
	{ endpoint: 'users/follow', login: true, limitDuration: hour, limitMax: 100, minInterval: 1000 },
	{ endpoint: 'users/unfollow', login: true, limitDuration: hour, limitMax: 100, minInterval: 1000 },
	...
	{ endpoint: 'posts/mentions/show', login: true, limitDuration: 10 * minute, limitMax: 100 },
	{ endpoint: 'posts/mentions/delete-all', login: true },
	...
	{ endpoint: 'talks/messages/say', login: true, limitDuration: hour, limitMax: 120, minInterval: 1000 },
	...
	{ endpoint: 'talks/group/invitations/decline', login: true },
